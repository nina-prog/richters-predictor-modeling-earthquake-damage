...
```
cd existing_repo
git remote add origin https://git.scc.kit.edu/data-science-lab-2023/group-5-targaryen/phase-1.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.scc.kit.edu/data-science-lab-2023/group-5-targaryen/phase-1/-/settings/integrations)
